      ...
      <div className="w-full">
        ...
        <div className="flex items-center justify-between mb-4">
          <button 
            ...
            className="p-3 hover:bg-slate-100 rounded-full text-slate-600 transition-colors active:scale-90"
          >
            <ChevronLeft size={24} />
          </button>
        ...
        <div className="grid grid-cols-7 mb-2 text-center">
          {weekDays.map(d => (
            <div key={d.toString()} className="text-[10px] font-black text-slate-400 uppercase py-1 tracking-widest">
  ...
  return (
    <div className={className}>
      ...
      <div 
        ...
        onClick={handleOpen}
      >
        <div className="absolute left-3 top-1/2 -translate-y-1/2 text-slate-400 group-hover:text-brand-500 transition-colors">
        ...
        <input
          ...
          className="w-full pl-10 pr-4 py-3 bg-white border border-slate-200 rounded-xl outline-none text-slate-900 focus:ring-2 focus:ring-brand-500 cursor-pointer caret-transparent text-base font-medium shadow-sm transition-all hover:border-brand-200"
        />
      </div>
      ...
      {isOpen && (
        ...
        >
           <div 
             className="bg-white rounded-t-[32px] md:rounded-3xl shadow-2xl w-full max-w-sm overflow-hidden animate-slideUp md:animate-scaleIn h-auto max-h-[90dvh]"
           ...
           >
              ...
              <div className="flex justify-between items-center p-5 border-b border-slate-50">
                 <h3 className="font-black text-slate-900 text-xl tracking-tight uppercase">{label}</h3>
                 <button 
                   type="button"
                   onClick={() => setIsOpen(false)}
                   className="p-2 bg-slate-100 hover:bg-slate-200 text-slate-500 rounded-full transition-colors active:scale-90"
                 >
                   <X size={20} />
                 </button>
              </div>
              ...
              <div className="bg-slate-50 p-4 text-center border-t border-slate-100 flex gap-3">
                  <button 
                    type="button"
                    onClick={() => {
              ...
              <div className="h-[env(safe-area-inset-bottom)] bg-slate-50 md:hidden" />
           </div>
        </div>
      )}
    </div>
